...
class GetAllCouses {
  ...
  factory GetAllCouses.fromJson(Map<String, dynamic> json) {
    return _$GetAllCousesFromJson(json);
  }

  Map<String, dynamic> toJson() => _$GetAllCousesToJson(this);
}
